...
export const launchHelp = {
	...
	flags: {
		...
		"from-claude": Flags.boolean({ description: "Import a Claude Code session into RTX" }),
		"from-codex": Flags.boolean({ description: "Import a Codex session into RTX" }),
	...
	examples: [
		...
		`# Export a session file to HTML\n  ${APP_NAME} --export ~/.${APP_NAME}/agent/sessions/--path--/session.jsonl`,
	],
