...
${chalk.bold("Useful Commands:")}
  ${APP_NAME} agents unpack           - Export bundled subagents to ~/.${APP_NAME}/agent/agents (default)
  ${APP_NAME} agents unpack --project - Export bundled subagents to ./.${APP_NAME}/agents`;
}
