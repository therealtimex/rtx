...
export const acpHelp = {
	description: "Run RealtimeX as an ACP (Agent Client Protocol) server over stdio",
} satisfies CommandMetadata;

export const agentsHelp = { description: "Manage bundled task agents" } satisfies CommandMetadata;

export const authBrokerHelp = {
	description: "Manage the rtx auth-broker (credential vault)",
} satisfies CommandMetadata;
...
export const worktreeHelp = {
	description: "List or clear agent-managed git worktrees (~/.rtx/wt)",
} satisfies CommandMetadata;
