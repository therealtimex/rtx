...
export function getExtraHelpText(): string {
  ...
  Use \`rtx --profile <name> --alias <command>\` to create a shell shortcut for a profile
...
${chalk.bold("Useful Commands:")}
  rtx agents unpack           - Export bundled subagents to ~/.rtx/agent/agents (default)
  rtx agents unpack --project - Export bundled subagents to ./.rtx/agents`;
}
