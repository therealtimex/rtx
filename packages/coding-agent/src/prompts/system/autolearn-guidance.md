...
You can grow a library of reusable **managed skills** with the `manage_skill` tool. Managed skills are `SKILL.md` files kept in an isolated directory (`~/.rtx/agent/managed-skills`); they are surfaced to you in future sessions like any other skill.
