...
Managed skills: `SKILL.md` in isolated `~/.rtx/agent/managed-skills`; surfaced in future sessions like other skills.
...
Isolation: managed skills ONLY writable skills. NEVER edit user-authored skills in `~/.rtx/agent/skills` or `.rtx/skills`.
